...
ggplot(plotdata, aes(x = ga_,y = predictions_m1))+geom_point(color = 'lightgreen')
```

### Exercise: Calculate the predictions for features_val and ga_val. With the predicted values, make a plot predictions_m1_val and ga_val
```{r, warning=FALSE}
...
```{r}
plotdata = data.frame()
ggplot(plotdata, aes(x = ,y = ))+geom_point(color = '')
