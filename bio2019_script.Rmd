...
2. Using PCA or Random Fores, try creating a new feature set by adjusting the number of features kept.
...
### Exercise 9: 
Explore more combinations of models and features. Keep the results of the top 3 models you find. Discuss with your colleagues the results.
* Are they similar? How did you define the "best" models? 
* Can you think of a more efficient way to compare all the models available? 
